...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="startwith.css"> <!-- Import your CSS file -->
</head>
<body>
    <div>
        ...
        <section class="cards-wrapper">
            <div class="card-grid-space">
                <a class="card" href="./middle.php" style="--bg-img: url('https://www.pagetraffic.com/blog/wp-content/uploads/2022/09/latest-linkedin-logo-1.png')">
                    <div>
            ...
            <div class="card-grid-space">
                <a class="card" href="./middle.php" style="--bg-img: url('https://tax.thomsonreuters.com/blog/wp-content/uploads/sites/17/2023/01/AdobeStock_279424579-800x450.jpeg')">
                    <div>
            ...
            <div class="card-grid-space">
                <a class="card" href="./middle.php" style="--bg-img: url('https://miro.medium.com/v2/resize:fit:1100/format:webp/1*PsnGY7NGiSg7rF2TkVFEUA.png')">
                    <div>
